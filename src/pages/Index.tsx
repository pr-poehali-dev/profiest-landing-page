          ...
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@profies.ru" className="text-muted-foreground hover:text-primary transition-colors">er.profies@yandex.ru</a>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">г. Воронеж, ул. 303 стрелковой дивизии, д. 2А, оф. 68</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Пн-Пт: 8:00 - 17:00
Сб-Вс: выходной</p>
              </div>
            </div>
          </div>
